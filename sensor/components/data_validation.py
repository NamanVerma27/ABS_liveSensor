...
class DataValidation:
    ...
    def validate_number_of_columns(self, dataframe: DataFrame) -> bool:
        try:
            ...
            logging.info(f"Required number of columns: {len(self._schema_config['columns'])} , Present number of columns: {len(dataframe.columns)}")
        ...
        try:
            ...
            for column in base_df.columns:
                ...
                if column not in current_df.columns:
                    logging.warning(f"Column '{column}' present in base_df but missing in current_df. Skipping drift test for this column.")
                    continue
