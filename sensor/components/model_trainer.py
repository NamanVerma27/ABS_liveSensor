...
class ModelTrainer:
    ...
    def initiate_model_trainer(self) -> ModelTrainerArtifact:
        try:
            ...
            logging.info("Splitting training and testing arrays into input and target feature")
            ...
            logging.info("Calculating training and testing accuracy")
            ...
            logging.info(f"Training metric : {train_metric}")
            logging.info(f"Testing metric : {test_metric}")
            ...
            logging.info(f"Trained model saved at : {trained_model_file_path}")
